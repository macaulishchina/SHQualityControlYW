 ...
 */
class CommonSelectorJianChuXianyz(val activity: Activity, val list: ArrayList<JianChuXianData>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterJianChuXianyz(list)
 ...
 * 作者：scj
 */
class TodoAdapterJianChuXianyz(val list: ArrayList<JianChuXianData>) : BaseAdapter() {
