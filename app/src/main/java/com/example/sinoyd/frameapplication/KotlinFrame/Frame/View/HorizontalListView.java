 ...
 * 水平滑动的ListView
 * @author Jack
 * @version 创建时间：2014年6月17日  下午4:31:13
 */
public class HorizontalListView extends AdapterView<ListAdapter> {
     ...
     * @param listener
     */
    public void setOnScrollLeftListener(OnScrollLeftListener listener) {
    	mOnScrollLeftListener = listener;
    }
    ...
    protected synchronized void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // 滑动到最左边回调方法
        if(mOnScrollLeftListener != null){
        	if(mScroller.getCurrX() < 30){
        		mOnScrollLeftListener.onScrollLeft();
        	} else {
        		mOnScrollLeftListener.onScrollOutLeft();
        	}
        }
