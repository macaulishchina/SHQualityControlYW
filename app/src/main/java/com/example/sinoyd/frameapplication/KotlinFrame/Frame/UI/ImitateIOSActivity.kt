...
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.Dataclass.getidnamedata
...
class ImitateIOSActivity : BaseActivity() {
        ...
        bt.onClick {
            var comm = CommonSelector(act, getidnamedata(), object : CommonSelector.OnSelectClickListener {
                override fun onCommonItemSelect(postions: Int) {
                    toast(getidnamedata()[postions].namevalue)
                }
            })
            comm.showPop()
        }
