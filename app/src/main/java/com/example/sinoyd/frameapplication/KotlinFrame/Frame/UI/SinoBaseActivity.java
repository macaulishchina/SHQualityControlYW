package com.example.sinoyd.frameapplication.KotlinFrame.Frame.UI;
...
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.Config.ResConfig;
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.Config.ThemeConfig;
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.Uitl.LogUtil;
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.View.LoadingDialog;
 ...
 * 描述：业务基类 二次封装逻辑基类方法
 */
public class SinoBaseActivity extends BaseJActivity {
    ...
    public BaseJActivity getBaseActivity() {
        return this;
    }
