 ...
 */
class CommonSelectorString(val activity: Activity, val list: ArrayList<String>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterSimple(list)
 ...
 * 作者：scj
 */
class TodoAdapterSimple(val list: ArrayList<String>) : BaseAdapter() {
