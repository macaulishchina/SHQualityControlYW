 ...
 * 描述： 底部菜单弹出框
 */
public class FrmActionSheet extends Dialog implements OnClickListener {
	...
	public FrmActionSheet(Context context)
	{
	 ...
	 * @return
	 */
	public FrmActionSheet setCancelButtonTitle(String title)
	{
	 ...
	 * @return
	 */
	public FrmActionSheet setCancelButtonTitle(int strId)
	{
	 ...
	 * @return
	 */
	public FrmActionSheet setCancelableOnTouchMenuOutside(boolean cancelable)
	{
		mCancelableOnTouchOutside = cancelable;
		return this;
	}

	public FrmActionSheet addItems(String... titles)
	{
	...
	public FrmActionSheet setItemClickListener(MenuItemClickListener listener)
	{
