...
/**标液管理**/
/**现行有效标液**/
class Reductant_manager_xianxingyouxiaobiaoye_Fragment : Fragment() {
    var list: ArrayList<Idnamevalue> = ArrayList()


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val conview = inflater.inflate(R.layout.fragment_xianxingyouxiaobiaoye_reductant_layout, null)
        setview(conview)
        return conview
    }
