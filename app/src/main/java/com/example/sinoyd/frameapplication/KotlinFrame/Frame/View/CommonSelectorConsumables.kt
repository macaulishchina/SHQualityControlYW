 ...
 */
class CommonSelectorConsumables(val activity: Activity, val list: ArrayList<Consumables>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterConsumables(list)
 ...
 * 作者：scj
 */
class TodoAdapterConsumables(val list: ArrayList<Consumables>) : BaseAdapter() {
