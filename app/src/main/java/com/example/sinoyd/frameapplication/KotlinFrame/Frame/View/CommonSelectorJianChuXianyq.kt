 ...
 */
class CommonSelectorJianChuXianyq(val activity: Activity, val list: ArrayList<JianChuXianData>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterJianChuXianyq(list)
 ...
 * 作者：scj
 */
class TodoAdapterJianChuXianyq(val list: ArrayList<JianChuXianData>) : BaseAdapter() {
        ...
        return with(parent!!.context) {
            ...
            linearLayout {
                textView {
                    ...
                    text = list[i].instrumentName + "   " + list[i].pollutantName
                    textSize = 16f
