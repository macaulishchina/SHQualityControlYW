 ...
 */
class CommonSelectorInstrument(val activity: Activity, val list: ArrayList<Instrument>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterInstrument(list)
 ...
 * 作者：scj
 */
class TodoAdapterInstrument(val list: ArrayList<Instrument>) : BaseAdapter() {
