package com.example.sinoyd.frameapplication.KotlinFrame.Frame.Dialog
...
class DateSelectDialog : Dialog, View.OnClickListener {
    ...
    var enddatetext: TextView = TextView(context)
    ...
    fun setDateSelectListener(dateSelectListener: DateSelectListener): DateSelectDialog {
    ...
    private fun initView() {
        ...
        setContentView(R.layout.frame_date_selelct_layout)
        ...
        enddatetext.setTextColor(themecolor)
        ...
        when (v.id) {
            R.id.ok_btn -> {
                if (dateSelectListener != null) {
                    ...
                    if (date.isDateOneBigger(startDate.toString(), endDate.toString())) {
