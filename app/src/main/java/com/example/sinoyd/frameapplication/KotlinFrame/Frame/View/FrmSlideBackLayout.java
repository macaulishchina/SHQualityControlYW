...
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.UI.BaseJActivity;
import com.example.sinoyd.frameapplication.KotlinFrame.Frame.Uitl.DensityUtil;
...
public class FrmSlideBackLayout extends FrameLayout {
    ...
    private BaseJActivity mActivity;
    /**
    ...
    private void init(Context context) {
        //必须是传入Activity
        mActivity = (BaseJActivity) context;
        //构造ViewDragHelper
