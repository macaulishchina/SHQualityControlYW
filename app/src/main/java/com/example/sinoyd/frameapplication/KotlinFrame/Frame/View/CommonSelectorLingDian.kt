 ...
 */
class CommonSelectorLingDian(val activity: Activity, val list: ArrayList<LingDianData>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterLingDian(list)
 ...
 * 作者：scj
 */
class TodoAdapterLingDian(val list: ArrayList<LingDianData>) : BaseAdapter() {
