package com.example.sinoyd.frameapplication.KotlinFrame.Frame.Dataclass
...
//实现Idname接口的数据类
data class Idnamevalue(override var idkey: String, override var namevalue: String) : Idname
