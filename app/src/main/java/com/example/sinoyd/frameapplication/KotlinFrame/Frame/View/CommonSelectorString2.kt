 ...
 */
class CommonSelectorString2(val activity: Activity, val list: ArrayList<String>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterSimple2(list)
 ...
 * 作者：scj
 */
class TodoAdapterSimple2(val list: ArrayList<String>) : BaseAdapter() {
