 ...
 */
class CommonSelectorStandardSolutionChange(val activity: Activity, val list: ArrayList<StandardSolutionChange>, val callback: OnSelectClickListener) {
...
//        textv!!.setBackgroundColor(Color.RED)
    ...
    private fun initEvent() {
        var adapterr = TodoAdapterStandardSolutionChange(list)
 ...
 * 作者：scj
 */
class TodoAdapterStandardSolutionChange(val list: ArrayList<StandardSolutionChange>) : BaseAdapter() {
